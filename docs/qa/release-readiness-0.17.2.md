...
- PASS — `pnpm dlx biome lint src/question src/mcp/hermes-bridge.ts`
...
- PASS — `pnpm dlx biome lint src/cli/__tests__/question.test.ts plugins/oh-my-codex/.codex-plugin/plugin.json`
...
- Full `pnpm test` was not rerun locally after the targeted hotfix; targeted changed-surface tests and type/lint gates passed.
