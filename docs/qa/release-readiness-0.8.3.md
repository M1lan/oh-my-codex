...
|---|---|---|
| Build | `pnpm run build` | PASS (`real 9.15`) |
| Full test suite | `pnpm test` | PASS (`1926` pass / `0` fail, `real 498.76`, after clean `dist/` rebuild) |
| No-unused type gate | `pnpm run check:no-unused` | PASS (`real 4.73`) |
