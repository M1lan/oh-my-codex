...
- `node bin/omx.js sparkshell pnpm --version`
- `node bin/omx.js sparkshell git log --oneline -3`
- `pnpm test`

## Notes
- `pnpm test` removes the staged packaged sparkshell binary as part of packaging cleanup; I restored the tracked binary afterward.
