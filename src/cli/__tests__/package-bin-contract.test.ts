...
describe('package bin contract', () => {
  it('declares omx with an explicit relative bin path and avoids packaging platform-specific native binaries', () => {
    ...
    assert.ok(hasPacked('skills/ultrawork/references/agent-tiers.md'), 'expected pnpm pack output to include bundled ultrawork agent-tier reference');
    assert.ok(hasPacked('skills/ecomode/references/agent-tiers.md'), 'expected pnpm pack output to include bundled ecomode agent-tier reference');
    assert.ok(hasPacked('plugins/oh-my-codex/skills/ultrawork/references/agent-tiers.md'), 'expected pnpm pack output to include bundled plugin ultrawork agent-tier reference');
