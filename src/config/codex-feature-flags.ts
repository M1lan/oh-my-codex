...
export function supportsCodexPluginScopedHooks(
	options: { featuresListOutput?: string | null } = {},
): boolean {
...
export function resolveCodexHookFeatureFlag(
	options: {
