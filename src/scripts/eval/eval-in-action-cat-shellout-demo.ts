...
const stillUsesCatShellout =
	/execFileSync\('cat',\s*\[runtime\.manifestFile\]/.test(source);

if (stillUsesCatShellout) {
	process.stderr.write(
		"Evaluator: src/cli/autoresearch.ts still shells out to cat for the manifest.\n",
	);
