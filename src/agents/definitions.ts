...
export const AGENT_DEFINITIONS: Record<string, AgentDefinition> = {
	...
	"prometheus-strict-metis": {
		...
		description:
			"Prometheus Strict requirements interviewer and ambiguity mapper",
		reasoningEffort: "high",
		posture: "frontier-orchestrator",
		modelClass: "frontier",
		routingRole: "leader",
	...
	"prometheus-strict-momus": {
		...
		description:
			"Prometheus Strict adversarial plan critic and risk challenger",
		reasoningEffort: "high",
		posture: "frontier-orchestrator",
		modelClass: "frontier",
		routingRole: "leader",
	...
	"prometheus-strict-oracle": {
		...
		description:
			"Prometheus Strict implementation readiness verifier and handoff judge",
		reasoningEffort: "high",
		posture: "frontier-orchestrator",
		modelClass: "standard",
		routingRole: "leader",
