...
export function createHookPluginTmuxApi(
	options: HookPluginTmuxApiOptions,
): HookPluginSdk["tmux"] {
	return {
		sendKeys: (sendOptions: HookPluginSendKeysOptions) =>
			sendTmuxKeys(sendOptions, options),
	};
}
