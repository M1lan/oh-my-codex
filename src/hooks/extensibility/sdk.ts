...
export function createHookPluginSdk(
	options: HookPluginSdkOptions,
): HookPluginSdk {
...
export async function clearHookPluginState(
	cwd: string,
	pluginName: string,
): Promise<void> {
