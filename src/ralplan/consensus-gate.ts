...
export function buildRalplanConsensusGateFromSources(
	...
	if (nativeBlockedEvidence) {
		return {
			...
			blockedDetails: [
				trackerBackedNativeReviewPairProblem(
					nativeBlockedEvidence,
					nativeBlockedEvidence.options,
				),
				trackerBackedNativeReviewProblem(
					nativeBlockedEvidence.ralplan_architect_review,
					"architect",
					nativeBlockedEvidence.options,
				),
				trackerBackedNativeReviewProblem(
					nativeBlockedEvidence.ralplan_critic_review,
					"critic",
					nativeBlockedEvidence.options,
				),
