...
export function isTeamReminderIntent(
	value: unknown,
): value is TeamReminderIntent {
	return (
		typeof value === "string" &&
		TEAM_REMINDER_INTENTS.includes(value as TeamReminderIntent)
	);
}
...
export function resolveLeaderNudgeIntent(
	...
	const leaderActionState =
		typeof options.leaderActionState === "string"
